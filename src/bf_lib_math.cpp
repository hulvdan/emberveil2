...
struct Vector2Int {
  ...
  constexpr explicit Vector2Int(Vector2 a)
      : x((int)a.x)
      , y((int)a.y) {}

#endif

  constexpr Vector2Int(int x_, int y_)
      : x(x_)
      , y(y_) {}
};

// NOLINTNEXTLINE(runtime/references)
constexpr inline void operator+=(Vector2Int& a, const Vector2Int b) {
  a.x += b.x;
  a.y += b.y;
}
...
// NOLINTNEXTLINE(runtime/references)
constexpr inline void operator*=(Vector2Int& a, const int b) {
  a.x *= b;
  a.y *= b;
}
...
constexpr inline Vector2Int operator-(const Vector2Int a) {
  return {-a.x, -a.y};
}

constexpr inline Vector2Int operator+(const Vector2Int a, const Vector2Int b) {
...
constexpr inline Vector2Int operator*(const int a, const Vector2Int b) {
  return {a * b.x, a * b.y};
}

constexpr inline Vector2Int operator*(const Vector2Int a, const int b) {
  return {a.x * b, a.y * b};
}
...
constexpr inline bool operator==(const Vector2Int a, const Vector2Int b) {
  return (a.x == b.x) && (a.y == b.y);
}
...
constexpr inline Vector2 ToVector2(const Vector2Int value) {
...
static inline constexpr Vector2 Vector2Half() {
  return Vector2(0.5f, 0.5f);
}

static inline constexpr Vector2 Vector2Right() {
  return Vector2(1, 0);
}

static inline constexpr Vector2 Vector2Up() {
  return Vector2(0, 1);
}

static inline constexpr Vector2 Vector2Left() {
  return Vector2(-1, 0);
}

static inline constexpr Vector2 Vector2Down() {
  return Vector2(0, -1);
}
...
static inline constexpr Vector3 Vector3Right() {
  return Vector3(1, 0, 0);
}

static inline constexpr Vector3 Vector3Left() {
  return Vector3(-1, 0, 0);
}

static inline constexpr Vector3 Vector3Forward() {
  return Vector3(0, 0, 1);
}

static inline constexpr Vector3 Vector3Backward() {
  return Vector3(0, 0, -1);
}
...
static inline constexpr Vector4 Vector4Up() {
  return Vector4(0, 1, 0, 0);
}
static inline constexpr Vector4 Vector4Down() {
  return Vector4(0, -1, 0, 0);
}
static inline constexpr Vector4 Vector4Right() {
  return Vector4(1, 0, 0, 0);
}
static inline constexpr Vector4 Vector4Left() {
  return Vector4(-1, 0, 0, 0);
}
static inline constexpr Vector4 Vector4Forward() {
  return Vector4(0, 0, 1, 0);
}
static inline constexpr Vector4 Vector4Backward() {
  return Vector4(0, 0, -1, 0);
}
